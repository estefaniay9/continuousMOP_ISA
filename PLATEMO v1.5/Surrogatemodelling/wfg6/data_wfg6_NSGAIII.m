function Data=data_wfg6_NSGAIII
...
for r = 1:30
    ...
    % load it in
    if exist(strcat(algorithm, '_new_WFG6', '_probindex', pindex, '_', num2str(r), '.mat')) == 2
        load(strcat(algorithm, '_new_WFG6', '_probindex', pindex, '_', num2str(r), '.mat'))
    else
        % Run the algorithm on the problem to get the performance metrics
        main('-algorithm',str2func(algorithm),'-problem',@new_WFG6,'-N',100, '-zmin', x(1), '-run', r, ...
        ...
        load(fullfile(pwd,'Data', 'new_WFG6', algorithm, ...
        strcat(algorithm, '_', 'new_WFG6', '_probindex', pindex_2, '_', num2str(r), '.mat')));
    end
